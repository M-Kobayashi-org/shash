/*
 * The original string is hard to guess SHA512.
 *
...
DROP FUNCTION IF EXISTS ssha512//
CREATE FUNCTION ssha512 (plain TEXT, salt TEXT)
...
BEGIN
    ...
    DECLARE result TEXT;
    DECLARE idx INT;
    DECLARE hash_length INT DEFAULT 512;
