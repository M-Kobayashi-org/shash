/*
 * The original string is hard to guess SHA256.
 *
...
DROP FUNCTION IF EXISTS ssha256//
CREATE FUNCTION ssha256 (plain TEXT, salt TEXT)
...
BEGIN
    ...
    DECLARE result TEXT;
    DECLARE idx INT;
    DECLARE hash_length INT DEFAULT 256;
